...
var dialogModal=$( "#anchorPopup" ).dialog({
	...
	buttons: {
		...
		"Reset": function() {
			lat=currentLat;
			lon=currentLon;
			$("#anchorPopupLat").value=lat;
			$("#anchorPopupLon").value=lon;
			$("#anchorPopupRadius").value=0;
		}, 
		"+": function() {
			var maxRadius = +$("#anchorPopupMaxRadius").value;
			$("#anchorPopupMaxRadius").value=maxRadius+5;
		}
		, 
		"-": function() {
			var maxRadius = +$("#anchorPopupMaxRadius").value;
...
var AnchorControl = function (opt_options) {
	...
	var handleMenu = function (e) {
		...
		/*var dialogModal = nanoModal($("#anchorPopup"), {
			...
			update.values.forEach(function(value) {
				...
				if(value.value.latitude){
					...
					if(guard && lat &&lon){
						...
						$("#anchorPopupRadius").value=Math.round(radius);
