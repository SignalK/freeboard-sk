		...
		delta.updates.forEach(function(update) {
			...
			update.values.forEach(function(value) {
				...
				if(value.path === 'navigation.courseOverGroundTrue'){
					cog=true;
					setRotation(util.toRad(value.value), trackLine.getLastCoordinate());
				}
...
//every 5 minutes we should check vesselTrack and shorten/save it if required
//we keep last 5 min on screen
