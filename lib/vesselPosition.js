...
function setVesselOverlay(map,vessPos,vessTrack) {
...
function onmessage(delta) {
    ...
    if (delta.context !== 'vessels.' + this.ownVessel && delta.context !== 'vessels.self') {
        //console.log('Ignore, not:'+this.ownVessel);
        return;
    }
...
function setup(map) {
    ...
    vesselOverlay = setVesselOverlay(map, vesselPosition, vesselTrack);
