		...
		var dialogModal = nanoModal(document.querySelector("#saveFeaturePopup"), {
			...
			buttons: [{
				...
				handler: function(modal) {
					var name = dialogModal.querySelector("#saveFeaturePopupName").value;
					var desc = dialogModal.querySelector("#saveFeaturePopupDesc").value;
					var path = dialogModal.querySelector("#saveFeaturePopupPath").value;
