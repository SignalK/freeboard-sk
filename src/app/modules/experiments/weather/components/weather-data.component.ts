...
<<<<<<< HEAD
    ...
    template: `
        <div class="weather-data">
                ...
                <mat-step *ngFor="let item of data; let i= index;">
                    <div style="display:flex;">
                        <div style="min-width:50px;text-align:left;padding-top: 15%;">
                            <button mat-icon-button *ngIf="i!= 0 && data.length>1"
                            ...
                            <mat-card>
                                <div style="display:flex;flex-direction: column;">
                                    <div style="display:flex;">
                                        ...
                                        <div style="flex: 1 1 auto;">{{item.time.split(':').slice(0,2).join(':')}}</div>
                                    </div>  
                                    <div style="display:flex;">
                        ...
                        <div style="min-width:50px;text-align:right;padding-top: 15%;">
                            <button mat-icon-button *ngIf="i!= data.length-1"
                                (click)="currentPage= currentPage+1"
            ...
            <div style="text-align:center;font-size:10pt;font-family:roboto;">
                <mat-icon *ngFor="let c of data; let i=index;"
    ...
    `,
    styles: [`
        .weather-data h1 { font-weight: normal !important; }
        .weather-data-row {
            display: -webkit-box;      
            display: -moz-box;         
            display: -ms-flexbox;      
