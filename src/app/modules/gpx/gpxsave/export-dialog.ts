...
import { GPXSaveFacade } from './gpxsave.facade'
...
export class GPXExportDialog implements OnInit {
    ...
    ngOnInit() {
        this.parseResourceData(this.data);
    ...
    parseResourceData(data: { [key: string]: any }) {
        ...
        this.resData.routes.forEach(r => { this.selRoutes.push(false) });
        ...
        this.resData.waypoints.forEach(w => { this.selWaypoints.push(false) });
